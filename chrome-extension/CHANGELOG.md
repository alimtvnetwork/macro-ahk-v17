...
- Context menu specification document (`spec/05-chrome-extension/testing/03-context-menu-spec.md`)
...
### Added
- Comprehensive script reference spec (`spec/05-chrome-extension/40-macro-looping-script-complete-reference.md`) covering auth, credit formulas, progress bar colors, buttons, loop logic, and global API
