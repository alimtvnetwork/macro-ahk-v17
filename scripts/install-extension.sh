...
INSTALL_DIR="${HOME}/marco-extension"
VERSION=""
...
if [ -z "$VERSION" ]; then
  ...
  if [ -z "$VERSION" ]; then
    echo "❌ Could not detect latest version. Use --version to specify."
    exit 1
  fi
fi

echo "📦 Marco Extension ${VERSION}"
...
if ! curl -fSL -o "$TMP_ZIP" "$DOWNLOAD_URL"; then
  echo "❌ Download failed. Check version and repo."
...
# ── Done ──
echo ""
echo "✅ Marco Extension ${VERSION} installed to:"
echo "   ${INSTALL_DIR}"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
