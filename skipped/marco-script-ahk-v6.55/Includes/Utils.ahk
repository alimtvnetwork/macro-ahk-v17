...
global LOG_LEVEL_WARN  := "WARN"
global LOG_LEVEL_ERROR := "ERROR"
global LOG_LEVEL_DEBUG := "DEBUG"
...
InfoLog(msg, callerOverride := "") {
    WriteLog(LOG_LEVEL_INFO, msg, callerOverride)
}

WarnLog(msg, callerOverride := "") {
    WriteLog(LOG_LEVEL_WARN, msg, callerOverride)
}

ErrorLog(msg, callerOverride := "") {
    global LOG_FILE_ERROR

    WriteLog(LOG_LEVEL_ERROR, msg, callerOverride)
...
DebugLog(msg, callerOverride := "") {
    ...
    if isDebugEnabled {
        WriteLog(LOG_LEVEL_DEBUG, msg, callerOverride)
    }
}
