...
- `spec/04-macro-controller/credit-system.md` §Progress Bar Specification
- `spec/01-app-issues/02-status-bar-credit-display-mismatch.md`
- `spec/01-app-issues/37-compact-mode-bar-missing-segments.md`
