...
- `spec/04-macro-controller/ts-migration-v2/01-initialization-fix.md` — Phase 01 spec
- `spec/01-app-issues/authentication-freeze-and-retry-loop.md` — related auth fix
