...
- API reference: `spec/02-data-and-api/data-schema.md`
- Workspace detection: `spec/04-macro-controller/workspace-management.md`
- Cookie diagnostic: `combo.js` → `getBearerTokenFromCookie()` function
- Gap analysis: `spec/05-chrome-extension/14-gap-analysis-and-phase-plan.md`
