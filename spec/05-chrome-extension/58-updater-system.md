...
- `spec/02-data-and-api/db-join-specs/01-category-join-pattern.md` — Join pattern used
- `spec/02-data-and-api/data-models.md` — Full schema registry
- `spec/07-devtools-and-injection/sdk-convention.md` — SDK architecture
- `spec/05-chrome-extension/56-extension-update-mechanism.md` — Earlier update URL concept
