...
**Date**: 2026-03-23  
**Status**: Implemented  
**Spec**: `spec/05-chrome-extension/63-rise-up-macro-sdk.md`
...
- Spec 50: Script Dependency System (`spec/05-chrome-extension/50-script-dependency-system.md`)
- Spec 43: Macro Controller Extension Bridge (`spec/05-chrome-extension/43-macro-controller-extension-bridge.md`)
- Spec 58: Updater System (`spec/05-chrome-extension/58-updater-system.md`)
