...
> Reorganized: 2026-04-06 · See [spec-reorganization-plan.md](./spec-reorganization-plan.md) for migration history.
...
| **[05-design-diagram/](./05-design-diagram/)** | Diagram design specifications, Mermaid design system, visual standards |
...
- **Numbering**: Folders `01–12` are ordered by dependency/priority. No gaps.
