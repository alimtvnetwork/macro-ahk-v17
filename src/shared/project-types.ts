 ...
 * See spec/06-coding-guidelines/chrome-extension-guidelines/06-project-config-schema.md
 */
...
/** Dependency on a shared project. See spec/07-devtools-and-injection/sdk-convention.md */
